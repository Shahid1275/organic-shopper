// //  placeOrder payment controller
// import orderModel from "../models/orderModel.js";
// import userModel from "../models/userModel.js";
// import { v4 as uuidv4 } from 'uuid';

// // Place order controller for cash on delivery
...
//     if (!userId || !fullName || !streetAddress || !city || !state || !zipCode || !country || !phone) {
...
//         // In a real app, you would fetch the product price from database
//         // Here we'll just use a placeholder value
//         const price = 10; // Replace with actual product price lookup
...
//       status: "Order placed",
//       paymentMethod,
//       payment: paymentMethod === 'cod' ? false : true, // COD is not paid yet
//       date: Date.now(),
...
// // placeOrder payment controller using stripe
